	...
	if uploaded_file is not None:
		...
		if response1:
			with st.spinner("Generating visualizations..."):
				plot = query_engine.query("with reference to the provided dataset, Generate Python executable code using pandas to plot multiple chart types like, bar chart, pie chart, line chart, histogram and scatter plot. Ensure the code is structured to plot at least three different types of charts. Use subplots. Code only.")
			with card_container():
