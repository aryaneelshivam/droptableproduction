	...
	if uploaded_file is not None:
		...
		if response1:
			with st.spinner("Generating visualizations..."):
				plot = query_engine.query("Generate Python executable code to create three distinct subplotted charts from the dataset. Only executable code. Take column and row data from the given dataset.")
			with card_container():
