	...
	if uploaded_file is not None:
		...
		if response1:
			with st.spinner("Generating visualizations..."):
				plot = query_engine.query("Generate full Python executable code using pandas, to create three distinct subplotted charts from the dataset. Only executable code. Take column and row names from the given dataset. subplot 6 different charts for better understanding of the given data.")
			with card_container():
