	...
	if uploaded_file is not None:
		...
		if response1:
			with st.spinner("Generating visualizations..."):
				plot = query_engine.query("with reference to the provided dataset, Generate Python executable code using pandas to subplot multiple chart types. Ensure the code is structured to plot at least three different types of charts, such as line plots, bar plots, and scatter plots. Code only.")
			with card_container():
